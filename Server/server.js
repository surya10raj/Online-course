...
mongoose.connect('mongodb+srv://Surya:eZWdxDd7HiVPrQyF@cluster0.r67tkjk.mongodb.net/?retryWrites=true&w=majority', {
...
app.post('/api/addToCart', async (req, res) => {
  try {
    const { id, name, price, image,duration } = req.body;
